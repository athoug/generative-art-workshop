...
const sketch = ({width, height}) => {
  // let's get a random palette of 1-5 colors and set the colors
  ...
  while (grid.length > 2) {
    ...
    console.log('filtered grid', grid);

    // now lets form the trapezoid from point A to B
  ...
  // sort/layer the shapes according to their avarage y position
